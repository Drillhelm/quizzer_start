...
export const QuizExpanded = ({
    ...
    resetView,
    switchEdit
}: {quiz: Quiz, editQuiz: (quizId: number, quiz: Quiz) => void, resetView: () => void, switchEdit: () => void}) => {
    ...
    const totalPoints = filteredQuestions.reduce((prev: number, q: Question): number =>
        prev + q.points,
        0
    );
